...
/// A quick mood check-in entry (shared between iOS app and Watch)
...
enum QuickMood: Int, CaseIterable, Identifiable {
    ...
    var color: UIColor {
        switch self {
        case .great: return UIColor(red: 0.61, green: 0.81, blue: 0.53, alpha: 1)
        case .good: return UIColor(red: 0.83, green: 0.66, blue: 0.33, alpha: 1)
        case .okay: return UIColor(red: 0.55, green: 0.48, blue: 0.46, alpha: 1)
        case .low: return UIColor(red: 0.77, green: 0.44, blue: 0.42, alpha: 1)
        case .rough: return UIColor(red: 0.48, green: 0.24, blue: 0.22, alpha: 1)
        }
    }
}
